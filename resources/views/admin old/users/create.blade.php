...
@section('scripts')
    ...
    <script>
        ...
        $('#user[role]').on('click', function (e) {
            var x = $("option:selected", this);
        });

        function roleChangeListener(selectField) {
            var role = $(selectField).find("option:selected").val();
            var company_div = $('#company-div');
            var seller_div = $('#seller-div');
            var company_selector_div = $('#company-selector-div');
            console.log(role);
            switch (role) {
                case 'ordinary-user':
                    company_div.hide();
                    company_selector_div.hide();
                    seller_div.hide();
                    break;
                case 'associate-seller':
                    company_div.hide();
                    company_selector_div.show();
                    seller_div.show();
                    break;
                case 'main-seller':
                    company_div.show();
