              ...
              <div class="slider py-4">
                @foreach($flashSale->items->take(config::get('themeSetting.max_number_of_flash_sale_item')) as $item)
                  <div class="slider-item">
                    ...
                    <img src="{{ resize_image_url($item->product->images->first()->image, '200X200') }}" alt="Prodcuts1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                  <div class="product-item" style="padding-bottom: 40px;">
                    <a href="{{ route('products.show', $product->slug) }}" >
                      <img src="{{ resize_image_url($product->images->first()->image, '200X200') }}" alt="Prodcuts3">
            ...
            <div class="trending-item pt-4">
              <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                  <div class="product-item" style="padding-bottom: 40px;">
                    <a href="{{ route('products.show', $product->slug) }}" >
                      <img src="{{ resize_image_url($product->images->first()->image, '200X200') }}" alt="Prodcuts">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                          <div class="items bg-white">
                            ...
                            <div class="row">
                              ...
                              <a href=""><img src="{{resize_image_url($FeaturedCategoriesHasProduct->product->images->first()->image, '100X100') }}"
                                style="max-width: 95px; object-fit:cover" alt=""></a>
                              @endforeach
                            </div>
                          </div>
                        </div>
      ...
      <section id="deal" class="py-5">
        <div class="container-fluid py-4">
          ...
          <div class="grocery py-4">
            ...
            <div class="slider-item">
              <a href="{{route('products.show', $product->slug)}}" >
              <img src="{{resize_image_url($product->images->first()->image, '200X200')}}" alt="Prodcuts1">
              <h6 class="info-title text-dark mt-3">{{\Illuminate\Support\Str::limit($product->name , 24)}}</h6>
                <div class=" row">
                  <div class="col-auto mr-auto">
