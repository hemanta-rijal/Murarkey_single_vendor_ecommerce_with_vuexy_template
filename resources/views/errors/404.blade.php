                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                <div class="repair_img">
                                    {{--<img src="/assets/img/pum_repair.png" class="img img-responsive" alt="Image" style="margin: 0 auto;">--}}
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <p>Try searching or go to <a href="/">{{get_meta_by_key('site_name')}}'s home
                                            page</a></p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
