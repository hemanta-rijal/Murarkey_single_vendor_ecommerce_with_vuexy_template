                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Parlour Service For Name"
                                                        name="preferred_work[]"
                                                        id="prefer1"
                                                />
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Makeup"
                                                        name="preferred_work[]"
                                                        id="prefer2"
                                                />
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Hairstyling"
                                                        name="preferred_work[]"
                                                        id="prefer3"
                                                />
                                                <label class="custom-control-label" for="prefer3"
                                                       name="preferred_work[]"
                                                >Hairstyling</label
                                                >
                                            </div>
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Nail Extension/ Nail Art"
                                                        name="preferred_work[]"
                                                        id="prefer4"
                                                />
                                                <label class="custom-control-label" for="prefer4"
                                                       name="preferred_work[]"
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Bridal Service"
                                                        name="preferred_work[]"
                                                        id="prefer5"
                                                />
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Mehendi"
                                                        name="preferred_work[]"
                                                        id="prefer6"
                                                />
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Salon Service For Men"
                                                        name="preferred_work[]"
                                                        id="prefer7"
                                                />
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Bhaktapur"
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Kathmandu"
                                                        name="preferred_location[]"
                                                        id="preferloc2"
                                                />
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input
                                                        type="checkbox"
                                                        class="custom-control-input" value="Patan/Lalitpur"
                                                        name="preferred_location[]"
                                                        id="preferloc3"
                                                />
