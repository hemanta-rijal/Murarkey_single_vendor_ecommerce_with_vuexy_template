...
{{-- {{dd($parlour)}} --}}
    ...
    <section class="parlour-page">
      <div style="background: url('https://images.pexels.com/photos/1654834/pexels-photo-1654834.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940');" class="full-cover">
          <div class="overlay">
            <div class="logo">
                    ...
                    <div class="blog-details-inner">
                        ...
                        <div class="parlour-service mb-5">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <img src="{{asset('frontend/img/parlour at home.jpeg')}}" alt="">
                                    <h3>
                                      Makeup at home
                                    </h3>
