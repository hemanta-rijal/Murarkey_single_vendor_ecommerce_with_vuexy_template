<ul class="order-table">
    ...
    @foreach ($carts['content'] as $cart)
        <li class="fw-normal">
            ...
            <div class="quantity">
                <div class="pro-qty">
                    <input type="text" id="update-cart-content" name="qty[{{ $cart->rowId }}]" value="{{ $cart->qty }}"
                           onclick="updateCartContent(this.val())">
                </div>
            </div>
    ...
    <li class="fw-subtotal"><span>Shipping Ammount</span> <span></span>
        <span> {{ convert($carts['shippingAmount']) }}</span></li>
