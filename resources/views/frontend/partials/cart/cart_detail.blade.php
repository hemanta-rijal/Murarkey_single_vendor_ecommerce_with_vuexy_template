                                ...
                                @foreach ($carts['content'] as $cart)
                                    <tr>
                                        ...
                                        <td class="qua-col first-row">
                                            <div class="quantity">
                                                <div class="pro-qty">
                                                    <input type="text" name="qty[{{ $cart->rowId }}]"
                                                           value="{{ $cart->qty }}">
                                                </div>
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="cart-buttons">
                            <input type="button" id="target" class="submitcart primary-btn up-cart"
                                   value="Update cart"/>
                            <a href="{{ URL::to('products/search') }}" class="primary-btn continue-shop">Continue
                                shopping</a>
                        </div>
                    ...
                    <div class="col-lg-4 offset-lg-4">
                        <div class="proceed-checkout">
                            <ul>
                                ...
                                <li class="subtotal">Shipping
                                    Ammount<span> {{ convert($carts['shippingAmount']) }}</span></li>
