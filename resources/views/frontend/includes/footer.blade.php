            ...
            <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6 mt-5 pt-4">
                <div class="footer-left">
                    ...
                    <div class="" id="mc_embed_signup">
                        ...
                        <form target="" novalidate="true" action="{{ route('newsletter.add-subscriber') }}"
                              method="post" class="form-inline">
                            @csrf
                            <div class="d-flex flex-row">

                                <input class="form-control" name="subscriber_email" placeholder="Enter Email "
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="footer-social">
                    ...
                    @if (get_meta_by_key('linkedin_link'))
                        <a href="{{ get_meta_by_key('linkedin_link') }}"><i class="fa fa-linkedin"></i></a>
                    @endif
                    ...
                    @if (get_meta_by_key('google-plus_link'))
                        <a href="{{ get_meta_by_key('google-plus_link') }}"><i class="fa fa-google-plus"></i></a>
                    @endif
                </div>
            </div>
        </div>
