                    ...
                    <div class="sticky-wrapper">
                        <ul class="nav nav-tabs" id="serviceExplorer" role="tablist">
                            ...
                            @foreach ($serviceCategoryChild as $thirdChild)
                                <li class="nav-item">
                                    <a class="nav-link {{ $thirdChildTabCount == 0 ? 'active' : '' }}"
                                       id="{{ $thirdChild->slug }}" data-toggle="tab"
                                       href="{{ '#' . $thirdChild->slug . 'content' }}" role="tab" aria-controls="home"
                                       aria-selected="true">
                                        {!! $thirdChild->name !!}
                                    </a>
                                </li>
                                    ...
                                    @foreach ($thirdChild->services as $service)
                                        <div class="service-explore-card">
                                            ...
                                            <a onclick="openServiceDeatilSection('{{ $service->id }}')" href="#"
                                               class="view-btn">View Details <i class="fa fa-chevron-right"></i></a>
                                            <a onclick="openServiceDeatilSection('{{ $service->id }}')" href="#"
                                               data-target="#mbServiceExPopup" data-toggle="modal"
