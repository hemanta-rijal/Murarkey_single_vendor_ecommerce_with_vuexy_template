        ...
        <div style="width:90%; margin-left: auto;margin-right: auto;">
          <div style="background-color: #fff;margin-bottom: 2rem;padding: 2rem;">
            ...
            <table>
              <tbody>
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Order Code</td>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">{{$orderData['orderCode']}}</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Order date</td>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">{{$orderData['orderDate']}}</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Customer</td>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">{{$orderData['customer']}}</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Order Status</td>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">{{$orderData['status']}}</td>
                </tr>
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Email</td>
                ...
                <tr>
                  <td style="padding-bottom: 0.5rem;padding-top:0.5rem;min-width: 160px; border-bottom: 1px solid #f0f0f0;">Contact</td>
