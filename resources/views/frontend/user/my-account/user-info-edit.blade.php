                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          <ul class="list-group list-group-flush">
                           <li class="list-group-item">
                              <input type="text" name="name" class="form-control" placeholder="Shipping Name" value="{{$user->shipment_details->name}}"  required />
                            </li>
                            <li class="list-group-item">
                              <input type="text" name="address" class="form-control" placeholder="Shipping Address" value="{{$user->shipment_details->address}}"  required />
                            </li>
                            <li class="list-group-item">
                              <input type="text" name="email" class="form-control"  placeholder="email" value="{{$user->shipment_details->email}}"  required/>
                            </li>
                            <li class="list-group-item">
                              <input type="text" name="phone" class="form-control" placeholder="phone" value="{{$user->shipment_details->phone_number}}"  required />
                            </li>
                            <li class="list-group-item">
