        ...
        <div class="table-responsive">
            <form id="basicInfoForm" action="{{route('update.user-info',$user->id)}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="currency-selected">
                                <select name="supported_currency" class="form-control" id="">
                                    <option value="aud" {{$user->supported_currency=='aud' ? 'selected' : ''}}><img
                                                src="{{ asset('frontend/img/ausflag.png')}}" alt="">AUD
                                    </option>
                                    <option value="nrs" {{$user->supported_currency=='nrs' ? 'selected' : ''}}><img
                                                src="{{ asset('frontend/img/npflag.png')}}" alt="">NRS
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group has-success has-feedback">
                                ...
                                <input type="text" name="email" id="emailFiled" class="form-control" placeholder="Email"
                ...
                <div class="form-group pull-right">
                    <button type="button" class="btn btn-primary mt-4 justify-content-center" id="btnSubmitInfoForm"
    ...
    <script>
        ...
        $("#btnSubmitInfoForm").click(function (event) {
            ...
            if (currentEmail !== previousEmail) {
                if (confirm("Email you have provided is different. Therefore, if you update your details with new email, you will be logged out and you must verify your email throuh the verificaion link we have sent to your new email.")) {
