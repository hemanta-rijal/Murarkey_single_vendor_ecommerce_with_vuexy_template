                        ...
                        <form action="{{route('update.billing-detail')}}" method="POST">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Billing Name"
                                           value="{{$user->billing_details->name}}" required/>
                                </li>
                                <li class="list-group-item">
                                    <input type="text" name="address" class="form-control" placeholder="Billing Address"
                                           value="{{$user->billing_details->address}} " required/>
                                </li>
                                <li class="list-group-item">
                                    <input type="text" name="email" class="form-control" placeholder="email"
                                           value="{{$user->billing_details->email}}" required/>
                                </li>
                                <li class="list-group-item">
                                    <input type="text" name="phone_number" class="form-control" placeholder="phone"
                                           value="{{$user->billing_details->phone_number}}" required/>
                                </li>
                                <li class="list-group-item">
                                    <input type="text" name="city" class="form-control" placeholder="city"
                                           value="{{$user->billing_details->city}}" required/>
                                </li>
                                <li class="list-group-item">
                                    <input type="text" name="zip" class="form-control" placeholder="zip"
                                           value="{{$user->billing_details->zip}}" required/>
                                </li>
                            </ul>
                            </p>
