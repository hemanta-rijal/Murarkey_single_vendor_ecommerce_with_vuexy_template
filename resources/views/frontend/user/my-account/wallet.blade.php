                              ...
                              <div class="col-sm-7">
                                <div id="payment-type">
                                  @if (get_meta_by_key('esewa_status')=="on")
                                      <label>
                                            <input type="radio" name="payment_method"  value="esewa" onclick="fetchEsewaDetailForWallet()"  required/>
                                            <div>
...
{{--                              <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancel</button>--}}
                              <button type="submit" id="submitButton" style="display: none;" class="btn btn-primary" value="submit">Confirm</button>
                            </div>
                      </form>
                  </div>
            </div>
