                ...
                <div class="col-lg-6 pl-0">
                    <div class="contact-left">
                        <div class="contact-title">
                            <h4>Contacts Us</h4>
                            <p>We Deal With Various Makeup & Cosmetic Products! We Also Provide Beauty & Grooming
                                Services At Home.</p>
                        </div>
            ...
            <div class="row">
                                ...
                                @foreach ($testimonials as $testimonial)
                                    <div class="testimonial-item">
                                        <a href=" " class="testimony-pic">
                                            <img src="{{ resize_image_url($testimonial->image,'200X200')}}"
                ...
                <div class="col-md-6">
                    <div class="testimonial-about">
                        ...
                        <p>
                            We Deal With Various Makeup & Cosmetic Products! We Also Provide Beauty & Grooming Services
                            At Home.
                        </p>
