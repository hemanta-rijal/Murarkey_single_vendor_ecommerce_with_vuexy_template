                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck2">
                                         <a href=""><img src="{{ resize_image_url($item->options[0], '200X200') }}" alt="Product" width="100%"> </a>
                                    </div>
                                    <div class="col-7 py-3">
                                        ...
                                        <div class="row">
                                            <div class="quantity pt-3 pl-0">
                                                <input type='button' value='-' class='fas fa-minus ml-3 qtyminus' field='quantity'
                                                   data-price="{{ $item->price }}"
                                                   data-row-id="{{ $item->rowId }}"/>
                                            <input type='text' name='quantity-{{ $item->rowId }}'
                                                   value='{{ $item->qty }}' class='qty'/>
                                            <input type='button' value='+' class='fas fa-plus ml-3 qtyplus' field='quantity'
                                                   data-price="{{ $item->price }}"
                                                   data-row-id="{{ $item->rowId }}"/>
                                            </div>
                                            <div class="delete pt-3">
                                                ...
                                                <span>
                                                 ...
                                                 <form id="deleteCartItem" method="POST" action="{{ route('user.cart.destroy', $rowId) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                                                </form>
                                            </div>
                                            ...
                                            <div class="save pt-3">
                                                <a href="" id="addToWishList" data-value="{{$item->id}}"><span> <i class="far fa-heart text-muted"></i>Save for later</span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2 mt-4">
                                        ...
                                        <span class="discount text-muted">@if ($item->doDiscount) Rs.{{$item->doDiscount}} @endif</span>
                ...
                <div class="shipping details bg-white py-3">
                    ...
                    <div class="px-3 py-4">
                        <div class="row py-2">
                            ...
                            <div class="col-auto">
                                <span class="order-price font-weight-bold grand-total-price" id="totalAmount" data-amount="{{$total}}" >Rs. {{$total}}</span>
                              </div>
                            </div>
                    </div>
                    ...
                    <div class="button">
                        ...
                        <a href="#" data-amount={{$subTotal}} id='payment-button' class="btn btn-primary pay-khalti">Pay with Khalti</a>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function calculateAndDisplayTotal() {
            ...
            $('.grand-total-price').text(numeral(total+{{$tax}}+80).format('0,0'))
