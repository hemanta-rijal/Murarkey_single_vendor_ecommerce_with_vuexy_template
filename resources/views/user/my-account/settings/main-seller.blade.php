...
@section('sub-sub-content')
    <h3 class="col_title p-t-0">Seller Company Account Settings</h3>
    <p class="black">Do you wish to close your Seller Company Account?</p>
    {{ Form::open(['url' => '/user/my-account/close-company', 'method' => 'delete']) }}
    @if($errors->has('company_reason'))
        <p class="warning_box plz_fill" style="max-width:inherit;">
            ! Please provide reason for closing Seller Company account.
        </p>
    @endif
    <textarea name="company_reason" class="form-control"
              placeholder="Please provide your reason for closing your account"
              rows="10" style="">{{ old('company_reason') }}</textarea>
    ...
    <p class="black">Do you wish to close your User Account for this website? this will include all accounts
        you have (including Company Account, Associate Seller)</p>
