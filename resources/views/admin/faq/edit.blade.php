                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="name-vertical">Question<span
                                                                        class="text-danger">*</span></label>
                                                            <textarea type="text" id="name-vertical"
                                                                      class="form-control" name="question" rows="2"
                                                                      placeholder="FAQ"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="name-vertical">Answer<span
                                                                        class="text-danger">*</span></label>
                                                            <textarea type="text" id="name-vertical"
                                                                      class="form-control" name="answer" rows="5"
                                                                      placeholder="Answer"
