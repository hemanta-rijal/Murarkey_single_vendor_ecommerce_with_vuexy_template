						...
						<div class="col-12">
							...
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"><a href="#">Update Testimonial</a>
									</li>
								</ol>
							</div>
						</div>
						...
						<div class="col-md-8 col-12">
							<div class="card">
								...
								<div class="card-content">
									<div class="card-body">
										<form action="{{ route('admin.testimonials.update', $testimonial->id) }}" class="form form-vertical" method="POST" enctype="multipart/form-data">
											@method('put')
											{{ csrf_field() }}
											<div class="form-body">
												<div class="row">
													...
													<div class="col-4">
														<div class="form-group">
															<label for="Image-vertical">Image<span class="text-danger">*</span></label>
															<input type="file" id="image" class="form-control" name="image" placeholder="image" />
														</div>
													</div>
													<div class="col-4">
														<div class="form-group">
															<label for="Image-vertical">Ratings<span class="text-danger">*</span></label>
													...
													<div class="col-12">
														<div class="form-group">
															<label for="Description-id-vertical">Description<span class="text-danger">*</span></label>
															<textarea type="text" id="ck-editor1" class="form-control ck-editor__editable_inline" name="description" placeholder="Description" rows="5">{!! $testimonial->description !!}</textarea>
														</div>
													</div>
