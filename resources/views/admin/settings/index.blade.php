                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="{!! map_storage_path_to_link(get_meta_by_key('logo')) !!}"
                                                         style="zoom: 0.5;">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="supported_countries">Supported Countries<span
                                                ...
                                                <div class="form-group">
                                                    <label class="default_country">Default Country<span
                                                                style="color:red">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label class="supported_locales">Supported Locales<span
                                                                style="color:red">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label class="default_timezone">Default Timezone<span
                                                                style="color:red">*</span></label>
                                            ...
                                            <div class="tab-pane fade " id="general-vertical-maintenance"
                                                ...
                                                <form role="form" class="dashboardForm" method="post" action=" ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="maintenance_mode">Maintenance Mode<span
                                                                            style="color:red">*</span></label>
                                                                <div class="form-check">
                                                                    <input class="form-check-input"
                                                                           name="maintenance_mode" type="hidden"
                                                                           id="maintenance_mode" value="off">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="allowed_IPs">Allowed IPs<span
                                                                            style="color:red">*</span></label>
                                            ...
                                            <div class="tab-pane fade" id="general-vertical-currency" role="tabpanel"
                                                ...
                                                <form role="form" class="dashboardForm" method="post" action=" ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="supported_currencies">Supported Currencies<span
                                                                            style="color:red">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="default_currency">Default Currency<span
                                                                            style="color:red">*</span></label>
                                                                <input type="text" class="form-control"
                                            ...
                                            <div class="tab-pane fade " id="general-vertical-mail" role="tabpanel"
                                                ...
                                                <form role="form" class="dashboardForm" method="post" action=" ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="mail_from_address">Mail From Address<span
                                                                            style="color:red">*</span></label>
                                                                <input type="text" class="form-control"
                                                                       name="mail_from_address" id="mail_from_address"
                                                                       placeholder="https://webcart.envaysoft.com/#maintenance"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_from_name">Mail From Name<span
                                                                            style="color:red">*</span></label>
                                                                <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_host">Mail Host<span
                                                                            style="color:red">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_port">Mail Port<span
                                                                            style="color:red">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_username">Mail Username<span
                                                                            style="color:red">*</span></label>
                                                                <input type="text" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_password">Mail Password<span
                                                                            style="color:red">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mail_encryption">Mail Encryption<span
                                                                            style="color:red">*</span></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="newsletter_mode">Newsletter Mode<span
                                                                            style="color:red">*</span></label>
                                                                <div class="form-check">
                                                                    <input class="form-check-input"
                                                                           name="newsletter_mode" type="hidden"
                                                                           id="gridCheck1" value="off">
                                                                    <input class="form-check-input"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="mailchimp_list_id">Mailchimp List ID<span
                                                                            style="color:red">*</span></label>
                                                                <input type="text" class="form-control"
                                                    ...
                                                    <h5>Analytics
                                                        <h5>
                                                            <div class="form-group">
                                                                ...
                                                                <p class="help-block">
                                                                    To append this script just add : <span
                                                                            class="muted">@{!! get_meta_by_key('tacking') !!}</span>
                                                                    on your view.
                                                                </p>
                                                            </div>
                                                            <div class="form-group">
                                            ...
                                            <div class="tab-pane fade" id="general-vertical-custom" role="tabpanel"
                                                ...
                                                <form role="form" class="dashboardForm" method="post" action=" ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="custom_header">Header<span
                                                                            style="color:red">*</span></label>
                                                                <textarea type="text" class="form-control"
                                                                          name="custom_header" id="custom_header"
                                                                          rows="10"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="custom_footer">Footer<span
                                                                            style="color:red">*</span></label>
                                                                <textarea type="text" class="form-control"
                                                                          name="custom_footer" id="custom_footer"
                                                                          rows="10"
