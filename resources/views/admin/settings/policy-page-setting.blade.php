                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2 mb-md-0">
                        <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                            <li class="nav-item">
                                <a class="nav-link d-flex py-75 active" id="general-pill-return-policy" data-toggle="pill" href="#general-vertical-return-policy" aria-expanded="true">
                                    <i class="feather icon-globe mr-50 font-medium-3"></i>
                                    Return Policy
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex py-75 " id="general-pill-support-policy" data-toggle="pill" href="#general-vertical-support-policy" aria-expanded="true">
                                    <i class="feather icon-globe mr-50 font-medium-3"></i>
                                    support-policy
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex py-75" id="general-pill-privacy-policy" data-toggle="pill" href="#general-vertical-privacy-policy" aria-expanded="false">
                                    <i class="feather icon-globe mr-50 font-medium-3"></i>
                                    privacy-policy
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex py-75" id="general-pill-terms-condition" data-toggle="pill" href="#general-vertical-terms-condition" aria-expanded="false">
                                    <i class="feather icon-globe mr-50 font-medium-3"></i>
                                    Terms & Conditions
                                </a>
                            </li>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="general-vertical-return-policy" aria-labelledby="general-pill-return-policy" aria-expanded="true">
                                             <h3>Return Policy</h3>
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="general-vertical-support-policy" aria-labelledby="general-pill-support-policy" aria-expanded="true">
                                        ...
                                        <div class="tab-pane fade " id="general-vertical-privacy-policy" role="tabpanel" aria-labelledby="general-pill-privacy-policy" aria-expanded="false">
                                        ...
                                        <div class="tab-pane fade" id="general-vertical-terms-condition" role="tabpanel" aria-labelledby="general-pill-terms-condition" aria-expanded="false">
