	  ...
	  $('.delete_all').on('click', function(e) {
	   ...
	   if (allVals.length <= 0) {
	    ...
	    if (check == true) {
	     ...
	     $.ajax({
	      url: '{{ url('/admin/contact-us/bulk-delete') }}',
	      type: 'POST',
	      data: {
	 ...
	 function sendMails() {
	  ...
	  if (allVals.length <= 0) {
	   ...
	   $.ajax({
	    ...
	    url: '<?php echo e(route('admin.contact-us.mail-all.modal')); ?>',
	    success: function(data) {
	     console.log('data');
			...
			<div class="content-header row">
						...
						<div class="col-12">
							...
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">FeedBack (Contact Us)</a>
									</li>
				...
				<div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
					<div class="form-group breadcrum-right">
						<button class=" btn-icon btn btn-primary btn-round btn-sm" onclick="sendMails()"><i class="feather icon-envalope"></i> Send Bulk Mails
						</button>
						<div class="dropdown">
						</div>
					</div>
												...
												@foreach ($data as $item)
													<tr data-id="{{ $item->id }}">
														...
														<td class="product-action">
															<a href="{!! route('admin.contact-us.show', $item->id) !!}">
																<i class="feather icon-eye"></i>
															</a>
															<a href="#" onclick="confirm_modal('{{ route('admin.contact-us.destroy', $item->id) }}')">
