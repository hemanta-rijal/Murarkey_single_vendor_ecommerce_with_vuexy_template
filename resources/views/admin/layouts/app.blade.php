...
<head>
    ...
    <meta name="description"
          content="{!! get_meta_by_key('site_name') !!} admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
          content="admin template, {!! get_meta_by_key('site_name') !!} admin template, dashboard template, flat admin template, responsive admin template, web app">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ URL::asset('backend/app-assets/css/themes/semi-dark-layout.css') }}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css"
          href="{{ URL::asset('backend/app-assets/css/core/menu/menu-types/vertical-menu.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ URL::asset('backend/app-assets/css/core/colors/palette-gradient.css') }}">
