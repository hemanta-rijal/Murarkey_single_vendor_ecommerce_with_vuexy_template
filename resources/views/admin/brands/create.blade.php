                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Add New Brand</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name-vertical" class="form-control" name="name" placeholder="Brand Title" onkeyup="setSlug(this.value)" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="file" id="caption" class="form-control" name="caption" placeholder="caption" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="Description-id-vertical">Description</label>
                                                        <textarea type="text" id="ck-editor1" class="form-control ck-editor__editable_inline" name="description" placeholder="Description" rows="5" require="required"></textarea>
                                                    </div>
                                                </div>
