                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('admin.service-labels.update', $serviceLabel->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="name-vertical">Service Label Name <span
                                                                        class="text-danger">*</span></label>
                                                            <input type="text" id="name-vertical" class="form-control"
                                                                   name="name" placeholder="Service Label Name"
                                                                   value="{{ $serviceLabel->name }}" minlength="3"
                                                                   required/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
