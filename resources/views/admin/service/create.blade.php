											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="name-vertical">Service Title <span class="text-danger">*</span></label>
														<input type="text" id="name-vertical" class="form-control" name="title" placeholder="Service Title" required onkeyup="setSlug(this.value)">
													</div>
												</div>
												<div class="col-6">
													<div class="form-group">
											...
											<div class="row">
												<div class="col-12">
													<div class="form-group">
														...
														<textarea type="text" class="form-control" name="service_quote" placeholder="Service Qutoes " rows="3"></textarea>
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<label for="Description-id-vertical">Short
															Description</label>
														<textarea type="text" id="ck-editor2" class="form-control ck-editor__editable_inline" name="short_description" placeholder="Short Description" rows="5"></textarea>
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<label for="Description-id-vertical">Full
															Description</label>
														<textarea rows="8" type="text" id="ck-editor3" class="form-control ck-editor__editable_inline" name="description" placeholder="Full Description"></textarea>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-12">
													<div class="form-group">
														...
														<input class="form-control " name=" category_id" data-toggle="modal" data-target="#categorySelectModal" id="product_category">
														<input type="hidden" name="category_id" id="subsubcategory_id" value="" required>
													</div>
												</div>
												...
												<div class="col-6">
													<div class="form-group">
														...
														<input type="text" id="price-vertical" class="form-control" name="discount_rates" placeholder="Discount">
													</div>
												</div>
											</div>
											<hr>
