                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{route('admin.services.store')}}" class="form form-vertical"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control custom-switch custom-control-inline">
                                                                <input class="form-check-input" name="popular"
                                                                       type="hidden" id="popular" value="0">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="category_id"
                                                                   id="subsubcategory_id" value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="Description-id-vertical">Full
                                                                Description</label>
                                                            <textarea rows="8" type="text" id="ck-editor2"
                                                                      class="form-control ck-editor__editable_inline"
                                                                      name="description"
