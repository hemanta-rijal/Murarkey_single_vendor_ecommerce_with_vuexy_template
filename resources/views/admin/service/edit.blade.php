										...
										<div class="card-body">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-12">
														<div class="form-group">
															<label for="Image-vertical">Feature Image &nbsp; <span style="color: blue"> (Choose Multipe Image)</span></label>
												...
												<div class="row">
													<div class="col-12">
														<div class="form-group">
															...
															<textarea type="text" id="" class="form-control " name="service_quote" placeholder="Service Qutoes " rows="3">{!! $service->service_quote !!}</textarea>
														</div>
													</div>
													<div class="col-12">
														<div class="form-group">
															<label for="Description-id-vertical">Short
																Description</label>
															<textarea type="text" id="ck-editor2" class="form-control ck-editor__editable_inline" name="short_description" placeholder="Short Description" rows="4">{!! $service->short_description !!}</textarea>
														</div>
													</div>
													<div class="col-12">
														<div class="form-group">
															<label for="Description-id-vertical">Full
																Description</label>
															<textarea type="text" id="ck-editor3" class="form-control ck-editor__editable_inline" name="description" placeholder="Full Description" rows="8">{!! $service->description !!}</textarea>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="row">
													<div class="col-12">
														<div class="form-group">
															...
															<input class="form-control " name="" data-toggle="modal" data-target="#categorySelectModal" id="product_category"
																value="{{ $service->serviceCategory != null ? $service->serviceCategory->name : '' }}">
															<input type="hidden" name="category_id" id="subsubcategory_id" value="{{ $service->serviceCategory != null ? $service->serviceCategory->id : '' }}" required>
														</div>
													</div>
													...
													<div class="col-12">
														<div class="form-group">
															...
															<input type="number" id="service-charge" class="form-control" name="service_charge" placeholder="Service Charge" value="{{ $service->service_charge }}" />
														</div>
													</div>
													<div class="col-6">
														<div class="form-group">
													...
													<div class="col-6">
														<div class="form-group">
															<label for="price-vertical">Discount Rates</label>
															<input type="text" id="price-vertical" class="form-control" name="discount_rates" placeholder="Discount" value={{ $service->discount_rates }}>
														</div>
													</div>
												</div>
												<hr>
