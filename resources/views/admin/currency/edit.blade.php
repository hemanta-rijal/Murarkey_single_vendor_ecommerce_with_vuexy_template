                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       id="currencyField"
                                                                       value="{{ $currency->short_name }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                <label for="name-vertical">Currency Rate<span
                                                                            style="color: royalblue"> * reference on NRS base *</span><span
                                                                            class="text-danger">*</span></label>
                                                                <div class="row">
                                                                    <div class="col-1">
                                                                    </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="symbol_placement" class="form-control"
                                                                        ...
                                                                        required>
                                                                    <option value="front" {{ $currency->symbol_placement == 'front' ? 'selected' : '' }}>
                                                                        Front Of Amount
                                                                    </option>
                                                                    <option value="back" {{ $currency->symbol_placement == 'back' ? 'selected' : '' }}>
                                                                        Back Of Amount
                                                                    </option>
                                                                </select>
                                                            </div>
