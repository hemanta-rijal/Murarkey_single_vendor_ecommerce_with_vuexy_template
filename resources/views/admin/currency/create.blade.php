						...
						<div class="col-md-10  col-12">
							<div class="card">
								...
								<div class="card-content">
									<div class="card-body">
										<form action="{{ route('admin.currencies.store') }}" class="form form-vertical" method="POST" enctype="multipart/form-data">
											{{ csrf_field() }}
											<div class="card">
												<div class="form-body">
													<div class="row">
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Currency Name<span class="text-danger">*</span></label>
																<input type="text" class="form-control" name="currency_name" placeholder="currency Name" id="currencyField" required>
															</div>
														</div>
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Short Name<span class="text-danger">*</span></label>
																<input type="text" class="form-control" name="short_name" placeholder="currency short name(usd, nrs, aud ...etc)" id="currencyField" required>
															</div>
														</div>
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Currency Icon<span class="text-danger">*</span></label>
																<input type="file" class="form-control" name="icon" placeholder="currency icon or flag signs" id="currencyField" required>
															</div>
														</div>
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Currency Rate<span class="text-danger">*</span><span style="color: royalblue"> * reference on NRS base *</span></label>
																<div class="row">
																	<div class="col-1">
														...
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Symbol<span class="text-danger">*</span></label>
																<input type="text" class="form-control" name="symbol" placeholder="currency symbol" id="currencyField" required>
															</div>
														</div>
														<div class="col-4">
															<div class="form-group">
																<label for="name-vertical">Symbol Placement<span class="text-danger">*</span></label>
