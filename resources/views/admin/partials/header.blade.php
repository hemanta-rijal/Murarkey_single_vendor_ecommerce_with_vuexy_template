                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span
                                        class="user-name text-bold-600">{{ auth()->guard('admin')->user()->name }}</span><span
                                        class="user-status">Available</span></div>
                            <span><img class="round" src="{!! auth()->guard('admin')->user()->profile_pic_url !!}"
                                       alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="/admin/view-profile"><i class="feather icon-user"></i> View
                                Profile</a>
                            <a class="dropdown-item" href="/admin/edit-profile"><i class="feather icon-user"></i> Edit
                                Profile</a>
