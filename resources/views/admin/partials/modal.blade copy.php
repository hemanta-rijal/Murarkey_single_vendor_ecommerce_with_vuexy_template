<div class="modal-danger mr-1 mb-1 d-inline-block">
    ...
    {{--
    <button type="button" class="btn btn-icon btn-danger mr-1 mb-1 waves-effect waves-light" data-toggle="modal"
            data-target="#danger">
        <i class="feather icon-trash"></i> --}}

        <a href="#" class="{{$waves_effect ?? 'mr-1 mb-1 waves-effect waves-light'}} waves-light" data-toggle="modal"
           data-target="#danger">
            <i class="feather icon-trash"></i>
        </a>
        {{--
