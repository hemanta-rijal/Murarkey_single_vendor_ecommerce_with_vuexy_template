...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
	...
	<div class="main-menu-content">
		...
		<li class="nav-item {{ request()->is('admin/users*') ? 'active' : '' }} "><a href="#"><i class="feather icon-user"></i>
			...
			<ul class="menu-content">
				<li class=" {{ \Request::route()->getName() == 'admin.users.index' ? 'active' : '' }}"><a href="{{ route('admin.users.index') }}"><i class="feather icon-circle"></i><span
				...
				<li class=" {{ \Request::route()->getName() == 'admin.roles.index' ? 'active' : '' }}"><a href="{{ route('admin.roles.index') }}"><i class="feather icon-circle"></i><span
							class="menu-item" data-i18n="View All">Roles & Permissions</span></a>
				</li>
		...
		<li class=" nav-item {{ request()->is('admin/services*') ? 'active' : '' }}"><a href="#"><i class="feather icon-bell"></i>
			...
			<ul class="menu-content">
				...
				<li class="{{ \Request::route()->getName() == 'admin.service-categories.index' ? 'active' : '' }}">
					<a href="{{ route('admin.service-categories.index') }}"><i class="feather icon-sliders"></i><span class="menu-item" data-i18n="Service Categories">Service Categories</span></a>
				</li>
		...
		<li class=" nav-item {{ request()->is('admin/products*') ? 'active' : '' }}"><a href="#"><i class="feather icon-box"></i>
			...
			<ul class="menu-content">
				...
				<li class="{{ \Request::route()->getName() == 'admin.coupons.index' ? 'active' : '' }}"><a href="{{ route('admin.coupons.index') }}"><i class="feather icon-tag"></i><span
							class="menu-item" data-i18n="Apply Coupons">Apply Coupons</span></a>
				</li>
				...
				<li><a href="#"><i class="feather icon-list"></i><span class="menu-item" data-i18n="Categories">Categories</span></a>
					<ul class="menu-content">
						<li class="{{ \Request::route()->getName() == 'admin.categories.index' ? 'active' : '' }}">
							<a href="{{ route('admin.categories.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Product Categories">Product Categories</span></a>
						</li>
						<li class="{{ \Request::route()->getName() == 'admin.categories.order' ? 'active' : '' }}">
							<a href="{{ route('admin.categories.order') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Re-Order Categories">Re-Order Categories</span></a>
						</li>
					</ul>
				</li>
				...
				<li><a href="#"><i class="feather icon-box"></i><span class="menu-item" data-i18n="Products">Products</span></a>
					<ul class="menu-content">
						...
						<li class="{{ \Request::route()->getName() == 'admin.product.manage-stock.index' ? 'active' : '' }}">
							<a href="{{ route('admin.product.manage-stock.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Trash Items">Product Stocks</span></a>
						</li>
					</ul>
				</li>
		...
		<li class=" nav-item {{ request()->is('admin/parlour-listing*') ? 'active' : '' }}"><a href="#"><i class="feather icon-feather"></i>
			...
			<ul class="menu-content">
				...
				<li class="{{ \Request::route()->getName() == 'admin.parlour-listing.update-status' ? 'active' : '' }}">
					<a href="{{ route('admin.parlour-listing.index') }}?type=pending"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Pending List">Pending List</span></a>
				</li>
			</ul>
		</li>
		...
		<li class="{{ \Request::route()->getName() == 'admin.orders.index' ? 'active' : '' }}"><a href="{{ route('admin.orders.index') }}"><i class="feather icon-circle"></i><span
					class="menu-item" data-i18n="View All">View All</span></a>
		</li>
		</ul>
		</li>
		...
		<li class=" nav-item {{ request()->is('admin/faqs*') ? 'active' : '' }}"><a href="#"><i class="feather icon-help-circle"></i>
			...
			<ul class="menu-content">
				<li class="{{ \Request::route()->getName() == 'admin.faqs.index' ? 'active' : '' }}"><a href="{{ route('admin.faqs.index') }}"><i class="feather icon-circle"></i><span
							class="menu-item" data-i18n="View All">View All</span></a>
				</li>
				<li class="{{ \Request::route()->getName() == 'admin.faqs.create' ? 'active' : '' }}"><a href="{{ route('admin.faqs.create') }}"><i class="feather icon-circle"></i><span
							class="menu-item" data-i18n="Add New">Add New</span></a>
				</li>
			</ul>
		</li>
		...
		<li class=" nav-item {{ request()->is('admin/subscribers*') ? 'active' : '' }}"><a href="#"><i class="feather icon-mail"></i>
			...
			<ul class="menu-content">
				<li class="{{ \Request::route()->getName() == 'admin.newsletter.subscribers' ? 'active' : '' }}"><a href="{{ route('admin.newsletter.subscribers') }}"><i
							class="feather icon-circle"></i><span class="menu-item" data-i18n="All Subscribers">All Subscribers</span></a>
				</li>
			</ul>
		</li>
				...
				<li><a href="#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Frontend Settings">Frontend Settings</span></a>
					<ul class="menu-content">
						...
						<li class="{{ request()->is('admin/frontend-settings/homepage-setting') ? 'active' : '' }}">
							<a href="{!! route('admin.frontend-settings.homepage-setting') !!}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Home Page Settings">Home Page Settings</span></a>
						</li>
					</ul>
				</li>
				<li><a href="#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="System Settings">System Settings</span></a>
					<ul class="menu-content">
						...
						<li class="{{ request()->is('admin/policy-page-settings/general-setting') ? 'active' : '' }}">
							<a href="{!! route('admin.system-settings', 'policy-page-setting') !!}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Policy & Notice Settings">Policy Page Settings</span></a>
						</li>
						...
						<li class="{{ request()->is('admin/system-settings/social-login-setting') ? 'active' : '' }}">
							<a href="{!! route('admin.system-settings', 'social-login-setting') !!}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shipping Settings">Social Logins</span></a>
						</li>
					</ul>
				</li>
			</ul>
