...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="{{ URL::to('/admin') }}"><i class="feather icon-home"></i><span
                            class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
            </li>
            <li class=" navigation-header"><span>CMS</span>
            </li>
            <li class="nav-item {{ request()->is('admin/menus*') ? 'active' : '' }} "><a href="#"><i
                            class="feather icon-menu"></i>
                    <span class="menu-title" data-i18n="Menus">Menus</span></a>
                <ul class="menu-content">
                    <li class=" "><a href="{{ route('admin.menus.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="View All">View All</span></a>
                    </li>
            ...
            <li class="nav-item {{ request()->is('admin/users*') ? 'active' : '' }} "><a href="#"><i
                            class="feather icon-user"></i>
                    <span class="menu-title" data-i18n="Users">Users</span></a>
                <ul class="menu-content">
                    <li class=" {{ \Request::route()->getName() == 'admin.users.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.users.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                                    data-i18n="All Users">All Users</span></a>
                    </li>
                    <li class=" {{ \Request::route()->getName() == 'admin.admin-users.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.admin-users.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Admin Users">Admin Users</span></a>
                    </li>
                    <li class=" {{ \Request::route()->getName() == 'admin.roles.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.roles.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                                    data-i18n="View All">Roles & Permissions</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.users.sellers-trash' ? 'active' : '' }}"><a
                                href="{{ route('admin.users.trash') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Trash">Trash</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item {{ request()->is('admin/services*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-bell"></i>
                    <span class="menu-title" data-i18n="Services">Services</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.service-labels.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.service-labels.index') }}"><i
                                    class="feather icon-italic"></i><span
                                    class="menu-item" data-i18n="Service Labels">Service Labels</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.service-categories.index' ? 'active' : '' }}">
                        <a href="{{ route('admin.service-categories.index') }}"><i
                                    class="feather icon-sliders"></i><span class="menu-item"
                                                                           data-i18n="Service Categories">Service Categories</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.services.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.services.index') }}"><i class="feather icon-bell"></i><span
            ...
            <li class=" nav-item {{ request()->is('admin/products*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-box"></i>
                    <span class="menu-title" data-i18n="Products">Products</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.attributes.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.attributes.index') }}"><i class="feather icon-layers"></i><span
                                    class="menu-item" data-i18n="Product Attributes">Product Attributes</span></a>
                    </li>

                    <li class="{{ \Request::route()->getName() == 'admin.coupons.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.coupons.index') }}"><i class="feather icon-tag"></i><span
                                    class="menu-item"
                                    data-i18n="Apply Coupons">Apply Coupons</span></a>
                    </li>
                    ...
                    <li><a href="#"><i class="feather icon-list"></i><span class="menu-item" data-i18n="Categories">Categories</span></a>
                        <ul class="menu-content">
                            <li class="{{ \Request::route()->getName() == 'admin.categories.index' ? 'active' : '' }}">
                                <a href="{{ route('admin.categories.index') }}"><i class="feather icon-circle"></i><span
                                            class="menu-item"
                                            data-i18n="Product Categories">Product Categories</span></a>
                            </li>
                            <li class="{{ \Request::route()->getName() == 'admin.categories.order' ? 'active' : '' }}">
                                <a href="{{ route('admin.categories.order') }}"><i class="feather icon-circle"></i><span
                                            class="menu-item" data-i18n="Re-Order Categories">Re-Order Categories</span></a>
                            </li>
                        </ul>
                    </li>

                    <li><a href="#"><i class="feather icon-award"></i><span class="menu-item"
                                                                            data-i18n="Brands">Brands</span></a>
                        <ul class="menu-content">

                            <li class="{{ \Request::route()->getName() == 'admin.brands.index' ? 'active' : '' }}"><a
                                        href="{{ route('admin.brands.index') }}"><i
                                            class="feather icon-circle"></i><span
                                            class="menu-item" data-i18n="All Brands">All Brands</span></a>
                            </li>
                            {{-- <li class="{{\Request::route()->getName()=='admin.brands.import-export' ? 'active' : ''}}"><a href="{{ route('admin.brands.import-export') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Import/Export Brands">Import/Export Brands</span></a>
                            </li> --}}
                    ...
                    <li><a href="#"><i class="feather icon-box"></i><span class="menu-item" data-i18n="Products">Products</span></a>
                        <ul class="menu-content">
                            <li class="{{ \Request::route()->getName() == 'admin.products.index' ? 'active' : '' }}"><a
                                        href="{{ route('admin.products.index') }}"><i
                                            class="feather icon-circle"></i><span
                                            class="menu-item" data-i18n="All Products">All Products</span></a>
                            </li>
                            ...
                            <li class="{{ \Request::route()->getName() == 'admin.products.update-status' ? 'active' : '' }}">
                                <a href="{{ route('admin.products.index') }}?type=pending"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Pending Products">Pending Products</span></a>
                            </li>
                            <li class="{{ \Request::route()->getName() == 'admin.products.trash' ? 'active' : '' }}"><a
                                        href="{{ route('admin.products.trash') }}"><i
                                            class="feather icon-circle"></i><span
                                            class="menu-item" data-i18n="Trash Items">Trash Items</span></a>
                            </li>
                            <li class="{{ \Request::route()->getName() == 'admin.product.manage-stock.index' ? 'active' : '' }}">
                                <a href="{{ route('admin.product.manage-stock.index') }}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Trash Items">Product Stocks</span></a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class=" nav-item {{ request()->is('admin/parlour-listing*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-feather"></i>
                    <span class="menu-title" data-i18n="Parlour Listing">Parlour Listing</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.parlour-listing.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.parlour-listing.index') }}"><i
                                    class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="View All">View All</span></a>
                    </li>
                    ...
                    <li class="{{ \Request::route()->getName() == 'admin.parlour-listing.update-status' ? 'active' : '' }}">
                        <a href="{{ route('admin.parlour-listing.index') }}?type=pending"><i
                                    class="feather icon-circle"></i><span class="menu-item" data-i18n="Pending List">Pending List</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item {{ request()->is('admin/flash-sales*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-zap"></i>
                    <span class="menu-title" data-i18n="Flash Sale">Flash Sales</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.flash-sale.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.flash-sales.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="View All">View All</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.flash-sale.create' ? 'active' : '' }}"><a
                                href="{{ route('admin.flash-sales.create') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Add New">Add New</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item {{ request()->is('admin/orders*') ? 'active' : '' }}"><a href="#"><i
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ \Request::route()->getName() == 'admin.orders.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.orders.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                                    data-i18n="View All">View All</span></a>
                    </li>
                </ul>
            </li>

            <li class=" nav-item {{ request()->is('admin/reports*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-bar-chart-2"></i>
            ...
            <li class=" nav-item {{ request()->is('admin/testimonials*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-thumbs-up"></i>
                    <span class="menu-title" data-i18n="Testimonial">Testimonial</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.testimonials.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.testimonials.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="View All">View All</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.testimonials.create' ? 'active' : '' }}"><a
                                href="{{ route('admin.testimonials.create') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Add New">Add New</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item {{ request()->is('admin/faqs*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-help-circle"></i>
                    <span class="menu-title" data-i18n="FAQs">FAQs</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.faqs.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.faqs.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item"
                                    data-i18n="View All">View All</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.faqs.create' ? 'active' : '' }}"><a
                                href="{{ route('admin.faqs.create') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item"
            ...
            <li class=" nav-item {{ request()->is('admin/currencies*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-save"></i>
                    <span class="menu-title" data-i18n="Currencies">Currencies</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.currencies.index' ? 'active' : '' }}"><a
                                href="{{ route('admin.currencies.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="View All">View All</span></a>
                    </li>
                    <li class="{{ \Request::route()->getName() == 'admin.currencies.create' ? 'active' : '' }}"><a
                                href="{{ route('admin.currencies.create') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Add New">Add New</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item {{ request()->is('admin/subscribers*') ? 'active' : '' }}"><a href="#"><i
                            class="feather icon-mail"></i>
                    <span class="menu-title" data-i18n="NewsLetters">NewsLetters</span></a>
                <ul class="menu-content">
                    <li class="{{ \Request::route()->getName() == 'admin.newsletter.subscribers' ? 'active' : '' }}"><a
                                href="{{ route('admin.newsletter.subscribers') }}"><i
                                    class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="All Subscribers">All Subscribers</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item {{ request()->is('admin/home-page*') || request()->is('admin/theme*') || request()->is('admin/sliders*') || request()->is('admin/banners*') ? 'active' : '' }}">
                ...
                <ul class="menu-content">
                    <li><a href="#"><i class="feather icon-circle"></i><span class="menu-item"
                                                                             data-i18n="Frontend Settings">Frontend Settings</span></a>
                        <ul class="menu-content">
                            <li class="{{ request()->is('admin/banners*') ? 'active' : '' }}"><a
                                        href="{!! route('admin.banners.index') !!}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Banner Setting">Banner Setting</span></a>
                            </li>
                            <li class="{{ request()->is('admin/frontend-settings/homepage-setting') ? 'active' : '' }}">
                                <a href="{!! route('admin.frontend-settings.homepage-setting') !!}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Home Page Settings">Home Page Settings</span></a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="#"><i class="feather icon-circle"></i><span class="menu-item"
                                                                             data-i18n="System Settings">System Settings</span></a>
                        <ul class="menu-content">
                            <li class="{{ request()->is('admin/system-settings/general-setting') ? 'active' : '' }}"><a
                                        href="{!! route('admin.system-settings', 'general-setting') !!}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="General Settings">General Settings</span></a>
                            </li>
                            <li class="{{ request()->is('admin/policy-page-settings/general-setting') ? 'active' : '' }}">
                                <a href="{!! route('admin.system-settings', 'policy-page-setting') !!}"><i
                                            class="feather icon-circle"></i><span
                                            class="menu-item"
                                            data-i18n="Policy Page Settings">Policy Page Settings</span></a>
                            </li>

                            <li class="{{ request()->is('admin/system-settings/payment-setting') ? 'active' : '' }}"><a
                                        href="{!! route('admin.system-settings', 'payment-setting') !!}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Payment Settings">Payment Settings</span></a>
                            </li>
                            <li class="{{ request()->is('admin/system-settings/shipping-setting') ? 'active' : '' }}"><a
                                        href="{!! route('admin.system-settings', 'shipping-setting') !!}"><i
                                            class="feather icon-circle"></i><span class="menu-item"
                                                                                  data-i18n="Shipping Settings">Shipping Settings</span></a>
                            </li>
                            <li class="{{ request()->is('admin/system-settings/social-login-setting') ? 'active' : '' }}">
                                <a href="{!! route('admin.system-settings', 'social-login-setting') !!}"><i
                                            class="feather icon-circle"></i><span
                                            class="menu-item" data-i18n="Shipping Settings">Social Logins</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
