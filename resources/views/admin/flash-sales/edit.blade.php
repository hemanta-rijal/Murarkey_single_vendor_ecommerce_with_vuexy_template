                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="start_time-vertical"
                                                                           ...
                                                                           name="start_time"
                                                                           placeholder="Flash Sale Start Time"
                                                                           value="{{ $flashSale->start_time->format('d M, Y') }}"
                                                                           required>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="end_time-vertical"
                                                                           ...
                                                                           value="{{ $flashSale->end_time->format('d M, Y') }}"
                                                                           required>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="wend_timet-vertical">Publish Flash
                                                                        Sale</label>
                                                                    <div class=" custom-control custom-switch switch-lg custom-switch-success mr-2 mb-1">
                                                                        ...
                                                                        <input type="checkbox" name="published"
                                                                               ...
                                                                               id="customSwitch100"
                                                                               value="1" {{ $flashSale->published == true ? 'checked' : '' }}>
                                                                ...
                                                                <table class="table table-stripped">
                                                                    ...
                                                                    @foreach ($flashSale->items as $item)
                                                                        <tr id="old-item-{{ $item->id }}">
                                                                            ...
                                                                            <td>
                                                                                <select id="discount_type_{{ $item->id }}"
                                                                                        name="products[{{ $loop->index }}][discount_type]"
                                                                                        value="{{ $item->discount_type }}"
                                                                                        class="form-control"
                                                                                        style="width: auto;"
                                                                                        onchange="updateDiscountedPrice('{{ $item->id }}', '{{ $item->product->price }}')">
                                                                                    <option value="percentage" {{ $item->discount_type == 'percentage' ? 'selected' : '' }}>
                                                                                        %
                                                                                    </option>
                                                                                    <option value="price" {{ $item->discount_type == 'price' ? 'selected' : '' }}>
                                                                                        Price
                                                                                    </option>
                                                                                </select></td>

                                                                            <td><input id="discount_{{ $item->id }}"
                                                                                       type="number"
                                                                            ...
                                                                            <td><input type="number"
                                                                                       name="products[{{ $loop->index }}][actual_price]"
                                                                                       value="{{ $item->actual_price }}"
                                                                                       readonly="readonly"
                                                                                       class="form-control"></td>

                                                                            <td>
                                                                                <input id="discounted_price_{{ $item->id }}"
                                                                                       type="number"
                                                                                       name="products[{{ $loop->index }}][discounted_price]"
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <p>Search here product by name and add them for further update.
                                                        After adding <b>close</b> this modal or click <b>Done</b>Button
                                                        at last corner. </p>
                                                </div>
                                                <div class="card-content">
                                                    <div class="card-body">
