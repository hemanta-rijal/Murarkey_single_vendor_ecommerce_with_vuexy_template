...
@section('css')
    ...
    {{-- page css --}}
    <link rel="stylesheet" type="text/css"
          href="{{ asset('/backend/app-assets/css/plugins/extensions/drag-and-drop.css')}}">
    <link rel="stylesheet" type="text/css"
            ...
            <div class="content-body">
                ...
                <section id="sortable-lists">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button id="sortUpdate" type="button"
                                    class="btn btn-warning mr-1 mb-1 waves-effect waves-light float-right">Update Order
                            </button>
                        </div>
                    </div>
                </section>
