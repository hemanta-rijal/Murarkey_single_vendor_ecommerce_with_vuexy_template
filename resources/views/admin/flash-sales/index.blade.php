			...
			<div class="content-header row">
				...
				<div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
					<div class="form-group breadcrum-right">
						<a href="{{ route('admin.flash-sales.create') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle"><i class="feather icon-plus"></i> Add New</a>
						<div class="dropdown">
						</div>
					</div>
				</div>
			...
			<div class="content-body">
				...
				<section id="sortable-lists">
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-content">
									<div class="card-body">
										<p>Every entry of flash-sales can be drag and drop to sort their order at this
											page. You can simply drag and drop to the list and ger sorted order of list
															...
															<div class="row ">
																...
																<div class="col-2">
																	<h5 class="mt-0">
																		...
																		<a href="#" onclick="confirm_modal('{{ route('admin.flash-sales.destroy', $flashSale->id) }}')">
						...
						<div class="col-12">
							<button id="sortUpdate" type="button" class="btn btn-warning mr-1 mb-1 waves-effect waves-light float-right">Update Order
							</button>
						</div>
					</div>
				</section>
