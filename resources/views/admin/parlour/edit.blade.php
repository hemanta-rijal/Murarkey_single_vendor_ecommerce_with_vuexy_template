                        ...
                        <div class="col-md-10  col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="row m-0">
                                            <form action="{{ route('admin.parlour-listing.update', $parlour->id) }}"
                                                ...
                                                <div class="card">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="name-vertical"
                                                                           ...
                                                                           placeholder="Parlour Name" required
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="address-vertical">Slug<span
                                                                                class="text-danger">*</span></label>
                                                                    <input type="text" id="slug" class="form-control"
                                                                           name="slug" placeholder="Slug" required
                                                                           readonly value="{{ $parlour->slug }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="address-vertical">Address<span
                                                                                class="text-danger">*</span></label>
                                                                    <input type="text" id="address-vertical"
                                                                           class="form-control" name="address"
                                                                           placeholder="Parlour Address" required
                                                                           value="{{ $parlour->address }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="icon-info-vertical">Feature Image<span
                                                                                class="text-danger">*</span></label>
                                                                    <input type="file" id="icon-info-vertical"
                                                                           class="form-control" name="feature_image"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control custom-switch custom-control-inline">
                                                                        <input class="form-check-input" name="featured"
                                                                               type="hidden" id="featured" value="0">
                                                                        <input class="custom-control-input"
                                                                               name="featured" type="checkbox"
                                                                               id="customSwitch1"
                                                                               value="1" {{ $parlour->featured ? 'checked' : '' }}>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control custom-switch custom-control-inline">
                                                                        <input class="form-check-input" name="status"
                                                                               type="hidden" id="status" value="0">
                                                                        <input class="custom-control-input"
                                                                               name="status" type="checkbox"
                                                                               id="customSwitch2"
                                                                               value="1" {{ $parlour->status ? 'checked' : '' }}>
                                                                        <label class="custom-control-label"
                                                                               for="customSwitch2">
                                                                        </label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="name-vertical">Phone Contact<span
                                                                                class="text-danger">*</span></label>
                                                                    <input type="tel" id="phone-vertical"
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="tel" id="mobile-vertical"
                                                                           class="form-control" name="mobile"
                                                                           placeholder="Mobile Number"
                                                                           value="{{ $parlour->mobile }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="email-vertical">Email</label>
                                                                    <input type="email" id="email-vertical"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="Description-id-vertical">Description
                                                                        About Parlour <span class="text-danger">*</span></label>
                                                                    <textarea type="text" id="ck-editor1"
                                                                              class="form-control ck-editor__editable_inline"
                                                                              name="about"
                                                                              placeholder="Description about parlour"
                                                                              rows="5">{!! $parlour->about !!}</textarea>
