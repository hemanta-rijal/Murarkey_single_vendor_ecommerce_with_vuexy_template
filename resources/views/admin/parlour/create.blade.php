                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="tel" id="phone-vertical" class="form-control" name="phone" placeholder="Phone Number" >
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea type="text" id="Description-id-vertical" class="form-control" name="about" placeholder="Description about parlour" rows="5"></textarea>
                                                                </div>
                                                            </div>
