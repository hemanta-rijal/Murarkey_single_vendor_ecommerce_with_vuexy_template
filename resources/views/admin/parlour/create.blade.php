														...
														<div class="row">
															<div class="col-12">
																<div class="form-group">
																	...
																	<textarea type="text" id="ck-editor1" class="form-control ck-editor__editable_inline" name="about" placeholder="Description about parlour" rows="5" minlength="10"></textarea>
																</div>
															</div>
