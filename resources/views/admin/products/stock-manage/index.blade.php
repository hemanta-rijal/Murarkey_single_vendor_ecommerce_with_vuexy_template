                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="box-inline mar-btm pull-right">
                                        ...
                                        <div class="select">
                                            ...
                                            <button class="btn-icon btn btn-primary btn-sm" onclick="filterTable()">
                                                Filter
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <form action="{{route('admin.product.manage-stock.update')}}" method="POST">
                                                ...
                                                @foreach ($products as $product)
                                                    <tr data-id="{{$product->id}}">
                                                        ...
                                                        <td> {{ $product->sku }}</td>
                                                        <td>
                                                            <input class="form-control sku" type="number"
                                                                   name="stock_units[{{$product->id}}]"
                                                                   value="{{$product->total_product_units}}" disabled
                                                                   style="width: 80px;"/>
                                                        </td>
                                                    </tr>
                                            @endforeach
