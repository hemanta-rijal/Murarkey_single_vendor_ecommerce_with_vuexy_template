                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td class="product-action">
                                        <a href="{!! route('admin.products.show', $product->id) !!}" class="btn btn-icon btn-info mr-1 mb-1 waves-effect waves-light">
                                            <i class="feather icon-eye"></i>
                                        </a>
                                        <a href="{!! route('admin.products.edit', $product->id) !!}" class="btn btn-icon btn-primary mr-1 mb-1 waves-effect waves-light">
