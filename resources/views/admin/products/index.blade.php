			...
			<div class="content-header row">
				...
				<div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
					<div class="form-group breadcrum-right">
						...
						<a href="{{ route('admin.products.import-export') }}" class="btn-icon btn btn-warning btn-round btn-sm dropdown-toggle"><i class="feather icon-upload-cloud"></i> Import & Export</a>
						<div class="dropdown">
						</div>
					</div>
				</div>
											...
											<tbody>
												...
												<td class="product-action">
													...
													{{-- <a>
                                                            ...
                                                            <button type="submit"
                                                                    class="btn btn-icon btn-sm mr-1 mb-1 waves-effect waves-light">
                                                                <i class="feather icon-trash"></i>
                                                            </button>
                                                            {!! Form::close() !!}
                                                        </a> --}}
													<a href="#" onclick="confirm_modal('{{ route('admin.products.destroy', $product->id) }}')">
														<i class="feather icon-trash"></i>
													</a>
												</td>
												</tr>
