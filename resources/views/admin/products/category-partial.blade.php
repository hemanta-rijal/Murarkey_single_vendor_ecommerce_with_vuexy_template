                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-4 col-sm-12">
                                                <div class="list-group" id="list-tab" role="tablist">
                                                     ...
                                                     {{-- {{$category->slug}} --}}
                                                        <a class="list-group-item list-group-item-action active" id="list-{{$category->slug}}-list" data-toggle="list" href="#{{$category->slug}}" role="tab" aria-controls="list-home">Home</a>
