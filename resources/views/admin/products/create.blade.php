															...
															<div class="col-12">
																...
																<div class="col-12">
																	<div class="form-group">
																		...
																		<textarea type="text" id="ck-editor2" class="form-control ck-editor__editable_inline" name="shipping_details" placeholder="Shipping And Deliveary Details" rows="5"></textarea>
																	</div>
																</div>
																...
																<div class="col-12">
																	<div class="form-group">
																		...
																		<textarea type="text" id="ck-editor3" class="form-control ck-editor__editable_inline" name="packing_details" placeholder="Packaging Details" rows="5"></textarea>
																	</div>
																</div>
																<div class="col-12">
