                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('admin.users.store') }}" class="form form-vertical"
                                              method="POST">
                                            {{ csrf_field() }}
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="first-name-vertical">First Name<span
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="Last-name-vertical">Last Name<span
                                                                        class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <div class="controls has-icon-right position-relative">
                                                            <input id="pass_log_id1" type="password" name="password"
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <label>Repeat password must match<span
                                                                    class="text-danger">*</span></label>
                                                        <div class="controls">
