                                        ...
                                        <div class="col-md-3">
                                            <div class="ordersummary-right" style="padding-top: 25px;">
                                                <div class="order-summary">
                                                    ...
                                                    <a href="{{route('admin.orders.download-summary',$order->id)}}" class="btn btn-primary mt-3">
                                                        Download pdf
                                                    </a>
                                                    <a href="{{route('admin.orders.change-status',$order->id)}}" class="btn btn-outline-danger mt-3">
                                                        Cancell Order
                                                    </a>
                                            </div>
                                        </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="item">
                                                                                <img src="{{$item->options['photo']}}" alt="product-img" style="max-height: 100px; widht:auto; object-fit:center">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            {{$item->product->name  }}
