                    ...
                    <div class="col-md-8 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{route('admin.banners.update',$banner->id)}}" class="form form-vertical" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        @method('put')
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <img  class="form-group" src="{!! map_storage_path_to_link($banner->image) !!}" style="zoom: 0.5;width:300px;height:auto;object-fit:contain">
                                                ...
                                                <div class="col-6">
                                                     <div class="form-group">
                                                        ...
                                                        <input type="number" id="Weight-vertical" class="form-control" name="weight" placeholder="Banner Weight" value="{{$banner->weight}}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                     <div class="form-group">
                                                        <label for="name-vertical">Banner Link</label>
                                                        <input type="text" id="link-vertical" class="form-control" name="link" placeholder="Banner Link" value="{{$banner->link}}">
                                                    </div>
                                                </div>
