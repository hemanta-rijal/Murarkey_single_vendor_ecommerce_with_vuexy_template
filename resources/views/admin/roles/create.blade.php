                        ...
                        <div class="col-md-10 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{route('admin.roles.store')}}" class="form form-vertical"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="table-responsive border rounded px-1 ">
                                                            <h6 class="border-bottom py-1 mx-1 mb-0 font-medium-2"><i
                                                                        class="feather icon-lock mr-50 "></i>Assign
                                                                Permissions</h6>
                                                            <div class="row">
                                                                @php
                                                                    $switch_count =0;
                                                                ...
                                                                @foreach ($permission_groups as $group_name=>$groups)
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div class="card"><a data-action="collapse">
                                                                                <div class="card-header">
                                                                                    <h4 class="card-title">{{$group_name}}
                                                                                        - permissions</h4>
                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="form-control custom-switch custom-control-inline">
                                                                                                        ...
                                                                                                        <input class="custom-control-input"
                                                                                                               name="permissions[{{$group->slug}}]"
                                                                                                               type="checkbox"
                                                                                                               id="customSwitch{{$switch_count}}"
                                                                                                               value="{{true}}">
                                                                                                        {{-- //{{get_theme_setting_by_key('first_ad_status')==="on" ? 'checked' : ''}} --}}
                                                                                                        <label class="custom-control-label"
                                                                                                               for="customSwitch{{$switch_count}}">
                                                                                                        </label>
