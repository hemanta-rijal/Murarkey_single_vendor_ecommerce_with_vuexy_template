                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Add New BranRole</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{route('admin.roles.store')}}" class="form form-vertical" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name-vertical" class="form-control" name="name" placeholder="Role Name" >
                                                    </div>
                                                </div>
                                                 <div class="col-12">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <div class="form-control custom-switch custom-control-inline">
                                                                                                            ...
                                                                                                            <input class="custom-control-input" name="permissions[{{$group->slug}}]" type="checkbox" id="customSwitch{{$switch_count}}" value="{{true}}" > 
