			...
			<div class="content-header row">
				...
				<div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
					<div class="form-group breadcrum-right">
						<a href="{{ route('admin.attributes.create') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle"><i class="feather icon-plus"></i> Add New</a>
						<div class="dropdown">
						</div>
					</div>
				</div>
												...
												@foreach ($attributes as $attribute)
													<tr data-id="{{ $attribute->id }}">
														...
														<td class="product-action">
															...
															<a href="#" onclick="confirm_modal('{{ route('admin.attributes.destroy', $attribute->id) }}')">
