...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            {{-- //alert previous code --}}
            <div id="error-div" class="alert alert-success" role="alert" style="display:none;">Oops! Something went
                wrong
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p> The most basic list group is simply an unordered list with list items, and
                                            the proper
                                            classes.</p>

                                        <ol class="list-group class=" sortable
                                        "" id="basic-list-group">
