                                        ...
                                        <div class="media mb-2">
                                            ...
                                            <div class="media-body mt-50">
                                                ...
                                                <div class="col-12 d-flex mt-1 px-0">
                                                    <a href="profile/image-upload"
                                                       class="btn btn-primary d-none d-sm-block mr-75">Change</a>
                                                    <a href="profile/image-upload"
                                                       class="btn btn-primary d-block d-sm-none mr-75"><i
                                                                class="feather icon-edit-1"></i></a>
                                                    <a href="{{route('admin.remove-profile-pic')}}"
                                                       class="btn btn-outline-danger d-none d-sm-block">Remove</a>
                                                    <a href="{{route('admin.remove-profile-pic')}}"
                                                       class="btn btn-outline-danger d-block d-sm-none"><i
                                                ...
                                                <div class="col-sm-6 form-group ">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" class="form-control"
                                                               placeholder="Your Password" name="new_password" required
                                                ...
                                                <div class="col-sm-6 form-group ">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" class="form-control"
                                                               ...
                                                               required
                                                               data-validation-required-message="Confirm password field must match password strings of new password field"
                                                               data-validation-match-match="new_password" minlength="4"
                                                               max="15"/>
                                                    </div>
                                                </div>
