    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="pt-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{products_search_route($product->category->slug)}}">{{$product->category->name}}</a>
                </li>
                {{--
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 bg-white pb5">
                <div class="row bg-white">
                    <div class="col-6">
                        ...
                        {{-- {{dd(resize_image_url( str_replace('public','storage' ,
                        $product->images->first()->image),'600X600'))}}
                        ...
                        <div id="slideshow" class="fullscreen">
                            ...
                            <div id="img-{{++$loop->index}}" data-img-id="{{$loop->index}}"
                                 class="img-wrapper {{$loop->first ? 'active' : ''}}"
                                 style="background-image:  '{{resize_image_url( str_replace('public','storage' , $image->image),'600X600')}} ">
                            </div>
                            @endforeach
                            ...
                            <div class="thumbs-container bottom">
                                ...
                                <ul class="thumbs">
                                    @foreach($product->images as $image)
                                    <li data-thumb-id="{{++$loop->index}}"
                                        class="thumb {{$loop->first ? 'active' : '' }}"
                                        style="background-image: url('/{{str_replace('public','storage' , $image->image)}} ')">
                                    </li>
                                    @endforeach
                                </ul>
                    ...
                    <div class="col-6">
                        <div class="item-details mt-3">
                                <span id="heart">
                                    ...
                                    {{--  <a id="addToWishList" class="addToWishList" href=""
                                             onclick="document.getElementById('addToWishList').submit();"><i
                                                id="heart-liked" class="far fa-heart"></i></a>  --}}
                                </span>
                            ...
                            <div class="quantity pt-3" onkeypress="return event.keyCode != 13;">
                                ...
                                {{-- <span class="minus-btn"><i class="fas fa-minus ml-3 qtyminus" field='qty'
                                                                data-value="-"></i></span>
                                <input type="number" name="qty" value="1" class="qty display-quantity" id="qty-input-1">
                                <span class="plus-btn"><i class="fas fa-plus ml-3 qtyplus" field='qty'
                                                          data-value="+"></i></span> --}}
                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                <input type="hidden" name="product_image" value="{{$product->images->first()->image}}"
                                       id="product_image">
                            ...
                            <div class="button pt-4">
                                <a href="#" id="addToCartListAjax" class="addToCartList" data-value="{{$product->id}}">
                                    <button type="button" class="btn cart" id="addToCartList addToCartList"
                                            data-value="{{$product->id}}">Add to Cart
                                    </button>
                                </a>
                                <a href="#">
        ...
        <div class="row bg-white px-3 pt-4">
            <div class="col-xs-12 ">
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-details-tab" data-toggle="tab" href="#nav-details"
                           role="tab" aria-controls="nav-details" aria-selected="true">Product Details</a>
                        <a class="nav-item nav-link" id="nav-specification-tab" data-toggle="tab"
                           href="#nav-specification" role="tab" aria-controls="nav-specification" aria-selected="false">Specification</a>
                        <a class="nav-item nav-link" id="nav-delivery-tab" data-toggle="tab" href="#nav-delivery"
                           role="tab" aria-controls="nav-delivery" aria-selected="false">Packing & Delivery</a>
                        <a class="nav-item nav-link" id="nav-review-tab" data-toggle="tab" href="#nav-review" role="tab"
                           aria-controls="nav-review" aria-selected="false">Ratings & Reviews</a>
                        <a class="nav-item nav-link" id="nav-question-tab" data-toggle="tab" href="#nav-question"
                           role="tab" aria-controls="nav-question" aria-selected="false">Question & Answer</a>
                    </div>
                </nav>
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tab">
                    ...
                    <div class="tab-pane fade show" id="nav-specification" role="tabpanel"
                    ...
                    <div class="tab-pane fade show" id="nav-delivery" role="tabpanel"
                                    ...
                                    <div class="ratings pb-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 mx-auto mt-5">
                                                ...
                                                <div class="progress">
                                                    <span class="rate">{{$review->rating}}<i
                                                                class="fa fa-star "></i> </span>
                                                    <div class="progress-bar {{$review->rating==5 ? 'bg-green' : ( $review->rating==4 ? 'bg-yellow' : ( $review->rating==3 ? 'bg-blue' : ($review->rating==2 ? 'bg-pink' : ($review->rating==1 ? 'bg-red' : '') ) ) ) }}"
                                                         role="progressbar" style="width: {{$review->rating*20}}%"
                                                         aria-valuenow="{{$review->rating*20}}" aria-valuemin="0"
                                                ...
                                                <div class="row">
                                                    <div class="col-3">
                                                        <div class="user pl-5">
                                                            ...
                                                            <p>{{$review->created_at ?
                                                                $review->created_at->diffForHumans('y-m-d') : ''}}</p>
                                                    ...
                                                    <div class="col-3 text-center">
                                                        <span class="mr-3"><i
                                                                    class="far fa-thumbs-up mr-2"></i>Yes</span>
                    ...
                    <div class="tab-pane fade show" id="nav-question" role="tabpanel"
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="product-item">
                        <a href="{{route('products.show', $sim_product->slug)}}" target="_blank">
                            <img src="{{resize_image_url($sim_product->images->first()->image, '200X200')}}"
                                 alt="{{$sim_product->name}}">
