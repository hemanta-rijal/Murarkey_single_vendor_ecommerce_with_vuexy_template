            ...
            <nav aria-label="breadcrumb" class="pt-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{{products_search_route($product->category->slug)}}">{{$product->category->name}}</a>
                    </li>
                        ...
                        <div class="col-6">
                            <div class="item-details mt-3">
                                ...
                                <div class="product-title pt-5 pb-3">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-auto mr-auto product-rating">
                                            ...
                                            <a href="" class="item-info"> {{ $reviewInfo->sum('review_count') }}
                                                Reviews</a>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="quantity pt-3" onkeypress="return event.keyCode != 13;">
                                    ...
                                    <input type="hidden" name="product_image" value="{{$product->featured_image}}"
                                           id="product_image">
                                    <span class="availability">50 Pieces Available</span>
                                </div>

                                <div class="button pt-4">
                                    <a href="#" id="addToCartListAjax" class="addToCartList"
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="shipping bg-white py-3">
                        ...
                        <div class="sold px-3 py-4">
                            ...
                            <a href="{{products_search_by_company($product->company->slug )}}"
                               class="company">{{$product->company->name}}</a>
                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-details-tab" data-toggle="tab"
                               href="#nav-details" role="tab" aria-controls="nav-details" aria-selected="true">Product
                                Details</a>
                            ...
                            <a class="nav-item nav-link" id="nav-review-tab" data-toggle="tab" href="#nav-review"
                               role="tab" aria-controls="nav-review" aria-selected="false">Ratings & Reviews</a>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12">
                            <div class="product-item">
                                <a href="{{route('products.show', $sim_product->slug)}}" target="_blank">
                                    <img src="{{resize_image_url($sim_product->featured_image, '200X200')}}"
