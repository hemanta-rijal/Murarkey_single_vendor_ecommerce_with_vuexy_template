...
$.fn.clickToggle = function( f1, f2 ) {
   ...
   $(window).scroll(function(){
    if ($(window).scrollTop() >= 200) {
        $('#search-mobile').addClass('fixed-header');
        $('#menubar-mobile').css('display', 'none !important');
      
    }
    else {
        $('#search-mobile').removeClass('fixed-header');
      ...
      $(window).scroll(function(){
    if ($(window).scrollTop() >= 200) {
        $('#menubar-fix-desktop').addClass('fixed-header-desktop');
      
    }
    else {
        $('#menubar-fix-desktop').removeClass('fixed-header-desktop');
