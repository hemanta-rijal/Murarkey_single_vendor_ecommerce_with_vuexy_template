...
class MetaService implements MetaServiceContract
{
    ...
    public function updateSiteSettings($data, $logo = null)
    {
        ...
        if (array_key_exists('frontend_secondary_logo', $data)) {
            $files['frontend_secondary_logo'] = $data['frontend_secondary_logo']->store('public/frontend_secondary_logo');
        }
        if (array_key_exists('frontend_primary_logo', $data)) {
            $files['frontend_primary_logo'] = $data['frontend_primary_logo']->store('public/frontend_primary_logo');
        }
