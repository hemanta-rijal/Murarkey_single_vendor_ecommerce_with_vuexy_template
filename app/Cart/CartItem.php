...
class CartItem implements Arrayable, Jsonable
{
    ...
    {
        $cartItem =  new self($item->getBuyableIdentifier($options), $item->getBuyableDescription($options), $item->getBuyablePrice($options), $options);
        $cartItem->companyId = $item->company_id;
     ...
     * @return mixed
     */
    public function getDoDiscount()
    {
        return $this->doDiscount;
    }

    /**
     * @param mixed $doDiscount
     */
    public function setDoDiscount($doDiscount)
    {
